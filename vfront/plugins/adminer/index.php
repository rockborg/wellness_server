...
* @version 0.96 $Id: index.php 1003 2012-07-12 10:15:02Z marciuz $
...
function adminer_object() {
    ...
    class AdminerSoftware extends Adminer {
        ...
        function database() {
			...
			if(isset($GLOBALS['db1']['dbsqlite_version']) && $GLOBALS['db1']['dbsqlite_version']==2){

				$vers=$GLOBALS['db1']['dbsqlite_version'];
			}
			else{
				$vers='';
			}

            return $GLOBALS['db1']['dbtype'].$vers;
        }
	*/
