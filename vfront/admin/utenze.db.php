 ...
 * @version 0.96 $Id: utenze.db.php 1078 2014-06-13 15:35:53Z marciuz $
...
#
    ...
    echo "<p><label for=\"nome\" >"._('Name')." $obb</label><br />
    <input type=\"text\" size=\"40\" maxlength=\"200\" value=\"\" name=\"nome\" id=\"cognome\" /></p>
    ";
     
    echo "<p><label for=\"cognome\" >"._('Surname')." $obb</label><br />
