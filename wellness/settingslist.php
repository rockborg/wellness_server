...
class csettings_list extends csettings {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->settingsid->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->settingsid->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		// Initialize
		$sFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->settingsid->AdvancedSearch->ToJSON(), ","); // Field settingsid
		$sFilterList = ew_Concat($sFilterList, $this->aboutimage->AdvancedSearch->ToJSON(), ","); // Field aboutimage
		$sFilterList = ew_Concat($sFilterList, $this->abouttext->AdvancedSearch->ToJSON(), ","); // Field abouttext
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field settingsid
		$this->settingsid->AdvancedSearch->SearchValue = @$filter["x_settingsid"];
		$this->settingsid->AdvancedSearch->SearchOperator = @$filter["z_settingsid"];
		$this->settingsid->AdvancedSearch->SearchCondition = @$filter["v_settingsid"];
		$this->settingsid->AdvancedSearch->SearchValue2 = @$filter["y_settingsid"];
		$this->settingsid->AdvancedSearch->SearchOperator2 = @$filter["w_settingsid"];
		$this->settingsid->AdvancedSearch->Save();

		// Field aboutimage
		$this->aboutimage->AdvancedSearch->SearchValue = @$filter["x_aboutimage"];
		$this->aboutimage->AdvancedSearch->SearchOperator = @$filter["z_aboutimage"];
		$this->aboutimage->AdvancedSearch->SearchCondition = @$filter["v_aboutimage"];
		$this->aboutimage->AdvancedSearch->SearchValue2 = @$filter["y_aboutimage"];
		$this->aboutimage->AdvancedSearch->SearchOperator2 = @$filter["w_aboutimage"];
		$this->aboutimage->AdvancedSearch->Save();

		// Field abouttext
		$this->abouttext->AdvancedSearch->SearchValue = @$filter["x_abouttext"];
		$this->abouttext->AdvancedSearch->SearchOperator = @$filter["z_abouttext"];
		$this->abouttext->AdvancedSearch->SearchCondition = @$filter["v_abouttext"];
		$this->abouttext->AdvancedSearch->SearchValue2 = @$filter["y_abouttext"];
		$this->abouttext->AdvancedSearch->SearchOperator2 = @$filter["w_abouttext"];
		$this->abouttext->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->aboutimage, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->abouttext, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->settingsid); // settingsid
			$this->UpdateSort($this->aboutimage); // aboutimage
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				$sOrderBy = "";
				$this->setSessionOrderBy($sOrderBy);
				$this->settingsid->setSort("");
				$this->aboutimage->setSort("");
			}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->settingsid->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function RenderRow() {
		...
		$this->aboutimage->ViewCustomAttributes = "";
			...
			if ($this->aboutimage->UseColorbox) {
				...
				$this->aboutimage->LinkAttrs["data-rel"] = "settings_x" . $this->RowCnt . "_aboutimage";
...
<?php if ($settings->settingsid->Visible) { // settingsid ?>
	<?php if ($settings->SortUrl($settings->settingsid) == "") { ?>
		<th data-name="settingsid"><div id="elh_settings_settingsid" class="settings_settingsid"><div class="ewTableHeaderCaption"><?php echo $settings->settingsid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="settingsid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $settings->SortUrl($settings->settingsid) ?>',1);"><div id="elh_settings_settingsid" class="settings_settingsid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $settings->settingsid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($settings->settingsid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($settings->settingsid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($settings->aboutimage->Visible) { // aboutimage ?>
	<?php if ($settings->SortUrl($settings->aboutimage) == "") { ?>
		<th data-name="aboutimage"><div id="elh_settings_aboutimage" class="settings_aboutimage"><div class="ewTableHeaderCaption"><?php echo $settings->aboutimage->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="aboutimage"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $settings->SortUrl($settings->aboutimage) ?>',1);"><div id="elh_settings_aboutimage" class="settings_aboutimage">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $settings->aboutimage->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($settings->aboutimage->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($settings->aboutimage->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($settings->settingsid->Visible) { // settingsid ?>
		<td data-name="settingsid"<?php echo $settings->settingsid->CellAttributes() ?>>
<span id="el<?php echo $settings_list->RowCnt ?>_settings_settingsid" class="settings_settingsid">
...
<a id="<?php echo $settings_list->PageObjName . "_row_" . $settings_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($settings->aboutimage->Visible) { // aboutimage ?>
		<td data-name="aboutimage"<?php echo $settings->aboutimage->CellAttributes() ?>>
<span id="el<?php echo $settings_list->RowCnt ?>_settings_aboutimage" class="settings_aboutimage">
<span>
