...
define("EW_PROJECT_NAME", "wellness", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{7060AD9E-0B65-4EDC-A749-00C6623FA119}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '09K5DGmxw2Rxe40v', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/wellness.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "likemescatter.com", "port" => 3306, "user" => "welladmin", "pass" => "Mide23415679", "db" => "wellness", "qs" => "`", "qe" => "`");
...
define("EW_MAX_FILE_SIZE", 8000000, TRUE); // Max file size
