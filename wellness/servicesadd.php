...
class cservices_add extends cservices {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["servicesid"] != "") {
				...
				$this->setKey("servicesid", $this->servicesid->CurrentValue); // Set up key
			} else {
				$this->setKey("servicesid", ""); // Clear key
	...
	function LoadDefaultValues() {
		$this->servicename->CurrentValue = NULL;
		$this->servicename->OldValue = $this->servicename->CurrentValue;
		$this->facility->CurrentValue = NULL;
		$this->facility->OldValue = $this->facility->CurrentValue;
		$this->community->CurrentValue = NULL;
		$this->community->OldValue = $this->community->CurrentValue;
		...
		$this->address_postcode->CurrentValue = NULL;
		$this->address_postcode->OldValue = $this->address_postcode->CurrentValue;
		$this->phone->CurrentValue = NULL;
		$this->phone->OldValue = $this->phone->CurrentValue;
		$this->website->CurrentValue = NULL;
		$this->website->OldValue = $this->website->CurrentValue;
		$this->peopleserved_gender->CurrentValue = NULL;
		$this->peopleserved_gender->OldValue = $this->peopleserved_gender->CurrentValue;
		$this->peopleserved_age->CurrentValue = NULL;
		$this->peopleserved_age->OldValue = $this->peopleserved_age->CurrentValue;
		$this->programtype->CurrentValue = NULL;
		$this->programtype->OldValue = $this->programtype->CurrentValue;
		$this->programfocus->CurrentValue = NULL;
		$this->programfocus->OldValue = $this->programfocus->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->servicename->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(servicename = '" . ew_AdjustSql($this->servicename->CurrentValue, $this->DBID) . "')";
		...
		// facility
		$this->facility->SetDbValueDef($rsnew, $this->facility->CurrentValue, "", FALSE);

		// community
		$this->community->SetDbValueDef($rsnew, $this->community->CurrentValue, "", FALSE);

		// address_street
		$this->address_street->SetDbValueDef($rsnew, $this->address_street->CurrentValue, "", FALSE);

		// address_city
		$this->address_city->SetDbValueDef($rsnew, $this->address_city->CurrentValue, "", FALSE);

		// address_postcode
		$this->address_postcode->SetDbValueDef($rsnew, $this->address_postcode->CurrentValue, "", FALSE);
		...
		// peopleserved_gender
		$this->peopleserved_gender->SetDbValueDef($rsnew, $this->peopleserved_gender->CurrentValue, "", FALSE);

		// peopleserved_age
		$this->peopleserved_age->SetDbValueDef($rsnew, $this->peopleserved_age->CurrentValue, "", FALSE);

		// programtype
		$this->programtype->SetDbValueDef($rsnew, $this->programtype->CurrentValue, "", FALSE);

		// programfocus
		$this->programfocus->SetDbValueDef($rsnew, $this->programfocus->CurrentValue, "", FALSE);
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->servicesid->setDbValue($conn->Insert_ID());
				$rsnew['servicesid'] = $this->servicesid->DbValue;
			}
		} else {
...
fservicesadd.Lists["x_peopleserved_gender"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesadd.Lists["x_peopleserved_gender"].Options = <?php echo json_encode($services->peopleserved_gender->Options()) ?>;
fservicesadd.Lists["x_peopleserved_age"] = {"LinkField":"x_name","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesadd.Lists["x_programtype"] = {"LinkField":"x_name","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesadd.Lists["x_programfocus"] = {"LinkField":"x_name","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesadd.Lists["x_zone"] = {"LinkField":"x_name","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
