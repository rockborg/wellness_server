	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$sThisKey .= $row['activitiesid'];
				$this->LoadDbValues($row);
				@unlink(ew_UploadPathEx(TRUE, $this->actimage->OldUploadPath) . $row['actimage']);
				$conn->raiseErrorFn = $GLOBALS["EW_ERROR_FN"];
...
factivitiesdelete.ValidateRequired = true;
<?php } else { ?>
factivitiesdelete.ValidateRequired = false; 
<?php } ?>
...
if ($activities_delete->Recordset = $activities_delete->LoadRecordset())
	$activities_deleteTotalRecs = $activities_delete->Recordset->RecordCount(); // Get record count
if ($activities_deleteTotalRecs <= 0) { // No record found, exit
	if ($activities_delete->Recordset)
		$activities_delete->Recordset->Close();
	$activities_delete->Page_Terminate("activitieslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($activities->activitiesid->Visible) { // activitiesid ?>
		<th><span id="elh_activities_activitiesid" class="activities_activitiesid"><?php echo $activities->activitiesid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($activities->acttitle->Visible) { // acttitle ?>
		<th><span id="elh_activities_acttitle" class="activities_acttitle"><?php echo $activities->acttitle->FldCaption() ?></span></th>
<?php } ?>
<?php if ($activities->actimage->Visible) { // actimage ?>
		<th><span id="elh_activities_actimage" class="activities_actimage"><?php echo $activities->actimage->FldCaption() ?></span></th>
<?php } ?>
<?php if ($activities->actlink->Visible) { // actlink ?>
		<th><span id="elh_activities_actlink" class="activities_actlink"><?php echo $activities->actlink->FldCaption() ?></span></th>
<?php } ?>
<?php if ($activities->dateadded->Visible) { // dateadded ?>
		<th><span id="elh_activities_dateadded" class="activities_dateadded"><?php echo $activities->dateadded->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($activities->activitiesid->Visible) { // activitiesid ?>
		<td<?php echo $activities->activitiesid->CellAttributes() ?>>
<span id="el<?php echo $activities_delete->RowCnt ?>_activities_activitiesid" class="activities_activitiesid">
...
<?php } ?>
<?php if ($activities->acttitle->Visible) { // acttitle ?>
		<td<?php echo $activities->acttitle->CellAttributes() ?>>
<span id="el<?php echo $activities_delete->RowCnt ?>_activities_acttitle" class="activities_acttitle">
...
<?php } ?>
<?php if ($activities->actimage->Visible) { // actimage ?>
		<td<?php echo $activities->actimage->CellAttributes() ?>>
<span id="el<?php echo $activities_delete->RowCnt ?>_activities_actimage" class="activities_actimage">
<span>
...
<?php } ?>
<?php if ($activities->actlink->Visible) { // actlink ?>
		<td<?php echo $activities->actlink->CellAttributes() ?>>
<span id="el<?php echo $activities_delete->RowCnt ?>_activities_actlink" class="activities_actlink">
...
<?php } ?>
<?php if ($activities->dateadded->Visible) { // dateadded ?>
		<td<?php echo $activities->dateadded->CellAttributes() ?>>
<span id="el<?php echo $activities_delete->RowCnt ?>_activities_dateadded" class="activities_dateadded">
