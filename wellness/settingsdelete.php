	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$sThisKey .= $row['settingsid'];
				$this->LoadDbValues($row);
				@unlink(ew_UploadPathEx(TRUE, $this->aboutimage->OldUploadPath) . $row['aboutimage']);
				$conn->raiseErrorFn = $GLOBALS["EW_ERROR_FN"];
...
<?php if ($settings->settingsid->Visible) { // settingsid ?>
		<th><span id="elh_settings_settingsid" class="settings_settingsid"><?php echo $settings->settingsid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($settings->aboutimage->Visible) { // aboutimage ?>
		<th><span id="elh_settings_aboutimage" class="settings_aboutimage"><?php echo $settings->aboutimage->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($settings->settingsid->Visible) { // settingsid ?>
		<td<?php echo $settings->settingsid->CellAttributes() ?>>
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_settingsid" class="settings_settingsid">
<span<?php echo $settings->settingsid->ViewAttributes() ?>>
<?php echo $settings->settingsid->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($settings->aboutimage->Visible) { // aboutimage ?>
		<td<?php echo $settings->aboutimage->CellAttributes() ?>>
<span id="el<?php echo $settings_delete->RowCnt ?>_settings_aboutimage" class="settings_aboutimage">
<span>
<?php echo ew_GetFileViewTag($settings->aboutimage, $settings->aboutimage->ListViewValue()) ?>
</span>
</span>
</td>
<?php } ?>
