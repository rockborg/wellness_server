...
class csettings_view extends csettings {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["settingsid"] <> "") {
			$this->RecKey["settingsid"] = $_GET["settingsid"];
			$KeyUrl .= "&amp;settingsid=" . urlencode($this->RecKey["settingsid"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["settingsid"] <> "") {
				...
				$this->RecKey["settingsid"] = $this->settingsid->QueryStringValue;
			} elseif (@$_POST["settingsid"] <> "") {
				$this->settingsid->setFormValue($_POST["settingsid"]);
				$this->RecKey["settingsid"] = $this->settingsid->FormValue;
			} else {
...
<?php if ($settings->settingsid->Visible) { // settingsid ?>
	<tr id="r_settingsid">
		<td><span id="elh_settings_settingsid"><?php echo $settings->settingsid->FldCaption() ?></span></td>
...
<?php echo $settings->settingsid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($settings->aboutimage->Visible) { // aboutimage ?>
	<tr id="r_aboutimage">
		<td><span id="elh_settings_aboutimage"><?php echo $settings->aboutimage->FldCaption() ?></span></td>
		<td data-name="aboutimage"<?php echo $settings->aboutimage->CellAttributes() ?>>
<span id="el_settings_aboutimage">
<span>
<?php echo ew_GetFileViewTag($settings->aboutimage, $settings->aboutimage->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($settings->abouttext->Visible) { // abouttext ?>
	<tr id="r_abouttext">
		<td><span id="elh_settings_abouttext"><?php echo $settings->abouttext->FldCaption() ?></span></td>
		<td data-name="abouttext"<?php echo $settings->abouttext->CellAttributes() ?>>
<span id="el_settings_abouttext">
<span<?php echo $settings->abouttext->ViewAttributes() ?>>
<?php echo $settings->abouttext->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
