...
// Header row
$View1->RowType = EW_ROWTYPE_HEADER;
...
?>
<?php if ($View1->websiteid->Visible) { // websiteid ?>
	<?php if ($View1->SortUrl($View1->websiteid) == "") { ?>
		<th data-name="websiteid"><div id="elh_View1_websiteid" class="View1_websiteid"><div class="ewTableHeaderCaption"><?php echo $View1->websiteid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="websiteid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->websiteid) ?>',1);"><div id="elh_View1_websiteid" class="View1_websiteid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->websiteid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($View1->websiteid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->websiteid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($View1->webname->Visible) { // webname ?>
	<?php if ($View1->SortUrl($View1->webname) == "") { ?>
		<th data-name="webname"><div id="elh_View1_webname" class="View1_webname"><div class="ewTableHeaderCaption"><?php echo $View1->webname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="webname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->webname) ?>',1);"><div id="elh_View1_webname" class="View1_webname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->webname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($View1->webname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->webname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($View1->webdesc->Visible) { // webdesc ?>
	<?php if ($View1->SortUrl($View1->webdesc) == "") { ?>
		<th data-name="webdesc"><div id="elh_View1_webdesc" class="View1_webdesc"><div class="ewTableHeaderCaption"><?php echo $View1->webdesc->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="webdesc"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->webdesc) ?>',1);"><div id="elh_View1_webdesc" class="View1_webdesc">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->webdesc->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($View1->webdesc->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->webdesc->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($View1->weblink->Visible) { // weblink ?>
	<?php if ($View1->SortUrl($View1->weblink) == "") { ?>
		<th data-name="weblink"><div id="elh_View1_weblink" class="View1_weblink"><div class="ewTableHeaderCaption"><?php echo $View1->weblink->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="weblink"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->weblink) ?>',1);"><div id="elh_View1_weblink" class="View1_weblink">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->weblink->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($View1->weblink->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->weblink->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($View1->createddate->Visible) { // createddate ?>
	<?php if ($View1->SortUrl($View1->createddate) == "") { ?>
		<th data-name="createddate"><div id="elh_View1_createddate" class="View1_createddate"><div class="ewTableHeaderCaption"><?php echo $View1->createddate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="createddate"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->createddate) ?>',1);"><div id="elh_View1_createddate" class="View1_createddate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->createddate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($View1->createddate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->createddate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($View1->categoryname->Visible) { // categoryname ?>
	<?php if ($View1->SortUrl($View1->categoryname) == "") { ?>
		<th data-name="categoryname"><div id="elh_View1_categoryname" class="View1_categoryname"><div class="ewTableHeaderCaption"><?php echo $View1->categoryname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="categoryname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $View1->SortUrl($View1->categoryname) ?>',1);"><div id="elh_View1_categoryname" class="View1_categoryname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $View1->categoryname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($View1->categoryname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($View1->categoryname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($View1->websiteid->Visible) { // websiteid ?>
		<td data-name="websiteid"<?php echo $View1->websiteid->CellAttributes() ?>>
<span<?php echo $View1->websiteid->ViewAttributes() ?>>
<?php echo $View1->websiteid->ListViewValue() ?></span>
<a id="<?php echo $View1_list->PageObjName . "_row_" . $View1_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($View1->webname->Visible) { // webname ?>
		<td data-name="webname"<?php echo $View1->webname->CellAttributes() ?>>
<span<?php echo $View1->webname->ViewAttributes() ?>>
<?php echo $View1->webname->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($View1->webdesc->Visible) { // webdesc ?>
		<td data-name="webdesc"<?php echo $View1->webdesc->CellAttributes() ?>>
<span<?php echo $View1->webdesc->ViewAttributes() ?>>
<?php echo $View1->webdesc->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($View1->weblink->Visible) { // weblink ?>
		<td data-name="weblink"<?php echo $View1->weblink->CellAttributes() ?>>
<span<?php echo $View1->weblink->ViewAttributes() ?>>
<?php echo $View1->weblink->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($View1->createddate->Visible) { // createddate ?>
		<td data-name="createddate"<?php echo $View1->createddate->CellAttributes() ?>>
<span<?php echo $View1->createddate->ViewAttributes() ?>>
<?php echo $View1->createddate->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($View1->categoryname->Visible) { // categoryname ?>
		<td data-name="categoryname"<?php echo $View1->categoryname->CellAttributes() ?>>
<span<?php echo $View1->categoryname->ViewAttributes() ?>>
<?php echo $View1->categoryname->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
