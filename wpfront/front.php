...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("applist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("bloglist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("categorylist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("eventlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("list_platformlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("userlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("websitelist.php");
		if ($Security->IsLoggedIn()) {
