...
class cuser_list extends cuser {
	...
	function Page_Init() {
		...
		$this->regdate->Visible = !$this->IsAddOrEdit();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->regdate); // regdate
			$this->UpdateSort($this->lastlogindate); // lastlogindate
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->_userid->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
...
fuserlist.Lists["x_categoryid"] = {"LinkField":"x_categoryid","Ajax":null,"AutoFill":false,"DisplayFields":["x_categoryname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
// Header row
$user->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($user->firstname->Visible) { // firstname ?>
	<?php if ($user->SortUrl($user->firstname) == "") { ?>
		<th data-name="firstname"><div id="elh_user_firstname" class="user_firstname"><div class="ewTableHeaderCaption"><?php echo $user->firstname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="firstname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->firstname) ?>',1);"><div id="elh_user_firstname" class="user_firstname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->firstname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->firstname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->firstname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->lastname->Visible) { // lastname ?>
	<?php if ($user->SortUrl($user->lastname) == "") { ?>
		<th data-name="lastname"><div id="elh_user_lastname" class="user_lastname"><div class="ewTableHeaderCaption"><?php echo $user->lastname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="lastname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->lastname) ?>',1);"><div id="elh_user_lastname" class="user_lastname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->lastname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->lastname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->lastname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($user->regdate->Visible) { // regdate ?>
	<?php if ($user->SortUrl($user->regdate) == "") { ?>
		<th data-name="regdate"><div id="elh_user_regdate" class="user_regdate"><div class="ewTableHeaderCaption"><?php echo $user->regdate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="regdate"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->regdate) ?>',1);"><div id="elh_user_regdate" class="user_regdate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->regdate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->regdate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->regdate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->lastlogindate->Visible) { // lastlogindate ?>
	<?php if ($user->SortUrl($user->lastlogindate) == "") { ?>
		<th data-name="lastlogindate"><div id="elh_user_lastlogindate" class="user_lastlogindate"><div class="ewTableHeaderCaption"><?php echo $user->lastlogindate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="lastlogindate"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->lastlogindate) ?>',1);"><div id="elh_user_lastlogindate" class="user_lastlogindate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->lastlogindate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->lastlogindate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->lastlogindate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->categoryid->Visible) { // categoryid ?>
	<?php if ($user->SortUrl($user->categoryid) == "") { ?>
		<th data-name="categoryid"><div id="elh_user_categoryid" class="user_categoryid"><div class="ewTableHeaderCaption"><?php echo $user->categoryid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="categoryid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->categoryid) ?>',1);"><div id="elh_user_categoryid" class="user_categoryid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->categoryid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->categoryid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->categoryid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->regdate->Visible) { // regdate ?>
		<td data-name="regdate"<?php echo $user->regdate->CellAttributes() ?>>
<span<?php echo $user->regdate->ViewAttributes() ?>>
<?php echo $user->regdate->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($user->lastlogindate->Visible) { // lastlogindate ?>
		<td data-name="lastlogindate"<?php echo $user->lastlogindate->CellAttributes() ?>>
<span<?php echo $user->lastlogindate->ViewAttributes() ?>>
<?php echo $user->lastlogindate->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($user->categoryid->Visible) { // categoryid ?>
		<td data-name="categoryid"<?php echo $user->categoryid->CellAttributes() ?>>
