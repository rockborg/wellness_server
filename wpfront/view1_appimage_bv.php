...
$View1_appimage_blobview = NULL; // Initialize page object first

class cView1_appimage_blobview extends cView1 {
	...
	// Page object name
	var $PageObjName = 'View1_appimage_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('View1', 'x_appimage');
...
// Create page object
if (!isset($View1_appimage_blobview)) $View1_appimage_blobview = new cView1_appimage_blobview();

// Page init
$View1_appimage_blobview->Page_Init();

// Page main
$View1_appimage_blobview->Page_Main();
?>
<?php
$View1_appimage_blobview->Page_Terminate();
?>
