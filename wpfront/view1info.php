...
class cView1 extends cTable {
	...
	function __construct() {
		...
		// websiteid
		$this->websiteid = new cField('View1', 'View1', 'x_websiteid', 'websiteid', '`websiteid`', '`websiteid`', 3, -1, FALSE, '`websiteid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->websiteid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['websiteid'] = &$this->websiteid;

		// webname
		$this->webname = new cField('View1', 'View1', 'x_webname', 'webname', '`webname`', '`webname`', 200, -1, FALSE, '`webname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['webname'] = &$this->webname;

		// webdesc
		$this->webdesc = new cField('View1', 'View1', 'x_webdesc', 'webdesc', '`webdesc`', '`webdesc`', 201, -1, FALSE, '`webdesc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['webdesc'] = &$this->webdesc;

		// weblink
		$this->weblink = new cField('View1', 'View1', 'x_weblink', 'weblink', '`weblink`', '`weblink`', 200, -1, FALSE, '`weblink`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['weblink'] = &$this->weblink;

		// createddate
		$this->createddate = new cField('View1', 'View1', 'x_createddate', 'createddate', '`createddate`', 'DATE_FORMAT(`createddate`, \'%d/%m/%Y %H:%i:%s\')', 135, 11, FALSE, '`createddate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->createddate->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['createddate'] = &$this->createddate;

		// categoryname
		$this->categoryname = new cField('View1', 'View1', 'x_categoryname', 'categoryname', '`categoryname`', '`categoryname`', 200, -1, FALSE, '`categoryname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->websiteid->EditValue = ew_HtmlEncode($this->websiteid->CurrentValue);
		$this->websiteid->PlaceHolder = ew_RemoveHtml($this->websiteid->FldCaption());
