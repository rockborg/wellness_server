...
define("EW_PROJECT_NAME", "wpfront", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{394CAB35-9A75-4A4A-AC50-D31C1662AE27}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'bkmb2csqR3Nlbe2S', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/wpfront.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", 'likemescatter.com', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'welladmin', TRUE);
define("EW_CONN_PASS", 'Mide23415679', TRUE);
define("EW_CONN_DB", 'wellness', TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../wellness/images/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,png", TRUE); // Allowed file extensions
