...
fuserview.Lists["x_categoryid"] = {"LinkField":"x_categoryid","Ajax":null,"AutoFill":false,"DisplayFields":["x_categoryname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($user->firstname->Visible) { // firstname ?>
	<tr id="r_firstname">
		<td><span id="elh_user_firstname"><?php echo $user->firstname->FldCaption() ?></span></td>
...
<?php if ($user->lastname->Visible) { // lastname ?>
	<tr id="r_lastname">
		<td><span id="elh_user_lastname"><?php echo $user->lastname->FldCaption() ?></span></td>
...
<?php if ($user->regdate->Visible) { // regdate ?>
	<tr id="r_regdate">
		<td><span id="elh_user_regdate"><?php echo $user->regdate->FldCaption() ?></span></td>
		<td<?php echo $user->regdate->CellAttributes() ?>>
<span id="el_user_regdate">
<span<?php echo $user->regdate->ViewAttributes() ?>>
<?php echo $user->regdate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user->lastlogindate->Visible) { // lastlogindate ?>
	<tr id="r_lastlogindate">
		<td><span id="elh_user_lastlogindate"><?php echo $user->lastlogindate->FldCaption() ?></span></td>
...
<?php echo $user->lastlogindate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user->categoryid->Visible) { // categoryid ?>
	<tr id="r_categoryid">
		<td><span id="elh_user_categoryid"><?php echo $user->categoryid->FldCaption() ?></span></td>
		<td<?php echo $user->categoryid->CellAttributes() ?>>
<span id="el_user_categoryid">
<span<?php echo $user->categoryid->ViewAttributes() ?>>
<?php echo $user->categoryid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
